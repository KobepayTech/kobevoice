...
2. Email security details to: [security@kobevoice.app](mailto:security@kobevoice.app)
3. Include:
...
- **Keep Kobevoice updated** - Updates include security patches
...
Kobevoice processes all audio locally by default. Your voice data never leaves your machine unless you explicitly enable remote server mode.
...
Thank you for helping keep Kobevoice secure! 🔒
