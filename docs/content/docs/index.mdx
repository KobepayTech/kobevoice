---
title: "Kobevoice Documentation"
description: "Kobevoice is the open-source, local-first AI voice studio — a free alternative to ElevenLabs and WisprFlow, running entirely on your machine."
---

Kobevoice is the **open-source, local-first AI voice studio** — a free
...
![Kobevoice App Screenshot](/images/app-screenshot-1.webp)
...
- **Agents speak back** — any MCP-aware agent can call Kobevoice to speak in one of your cloned voices
...
[View all releases](https://github.com/kobepaytech/kobevoice/releases/latest)

## Get Started

- [Installation](/overview/installation) — download and install Kobevoice
