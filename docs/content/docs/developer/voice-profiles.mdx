...
description: "How voice profile management works in Kobevoice"
---

## Overview

Voice profiles are the unit of "a saved voice" in Kobevoice. As of 0.4 they support two flavors backed by the same `profiles` table:
