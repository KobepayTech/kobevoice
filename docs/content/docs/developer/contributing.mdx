---
title: "Contributing"
description: "How to contribute to Kobevoice"
---

Thank you for your interest in contributing to Kobevoice! This guide will help you get started.
...
1. **Read the documentation** to understand how Kobevoice works
...
4. **Checked [`docs/PROJECT_STATUS.md`](https://github.com/kobepaytech/kobevoice/blob/main/docs/PROJECT_STATUS.md)** — the living engineering roadmap that tracks prioritized tasks (Tier 1 → 3), architectural bottlenecks, and candidate TTS engines under evaluation (including why some are backlogged)
...
<Files>
  <Folder name="kobevoice" defaultOpen>
    <Folder name="app/src">
...
- Check [existing issues](https://github.com/kobepaytech/kobevoice/issues) for bugs
- Test your fix thoroughly
- Add regression tests if possible

### New Features

- Check [`docs/PROJECT_STATUS.md`](https://github.com/kobepaytech/kobevoice/blob/main/docs/PROJECT_STATUS.md) and the [roadmap](https://github.com/kobepaytech/kobevoice#roadmap) before proposing work — the status doc lists prioritized tasks (Tier 1 → 3), known architectural bottlenecks, and candidate TTS engines already under evaluation (including why some have been backlogged)
...
- [CHANGELOG.md](https://github.com/kobepaytech/kobevoice/blob/main/CHANGELOG.md)
...
2. Read [`docs/PROJECT_STATUS.md`](https://github.com/kobepaytech/kobevoice/blob/main/docs/PROJECT_STATUS.md) for current engineering priorities
3. Search [existing issues](https://github.com/kobepaytech/kobevoice/issues)
4. Open a new issue or discussion
5. See [CONTRIBUTING.md](https://github.com/kobepaytech/kobevoice/blob/main/CONTRIBUTING.md) in the repo
