---
title: "Architecture"
description: "Understanding Kobevoice's technical architecture"
---

## System Overview

Kobevoice uses a client-server architecture with a React frontend and Python backend. The desktop app is built with Tauri and contains two main layers:
...
See [TTS Engines](/developer/tts-engines) for the full contract and integration phases, and [PROJECT_STATUS.md](https://github.com/kobepaytech/kobevoice/blob/main/docs/PROJECT_STATUS.md) for candidates under evaluation.
