...
description: "Set up your local development environment for Kobevoice"
---
...
| `just build-server-cuda` | **Windows:** CUDA server binary only, placed in `%APPDATA%/com.kobepaytech.kobevoice/backends/cuda` for local testing |
