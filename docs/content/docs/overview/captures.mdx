...
how Kobevoice strips Whisper loop hallucinations *before* the LLM sees the
...
The original audio is kept alongside the transcript in your Kobevoice data
...
[Remote Mode](/overview/remote-mode) for running Kobevoice as a server the rest
