---
title: "Installation"
description: "Download and install Kobevoice on macOS, Windows, or Linux"
---

## Download

Kobevoice is available for macOS and Windows, with Linux builds coming soon.
...
<Tabs items={["Apple Silicon", "Intel"]}>
  <Tab value="Apple Silicon">
    Download: [kobevoice_aarch64.app.tar.gz](https://github.com/kobepaytech/kobevoice/releases/latest/download/kobevoice_aarch64.app.tar.gz)

    ```bash
    # Extract the archive
    tar -xzf kobevoice_aarch64.app.tar.gz

    # Move to Applications
    mv Kobevoice.app /Applications/
    ```
  </Tab>
  <Tab value="Intel">
    Download: [kobevoice_x64.app.tar.gz](https://github.com/kobepaytech/kobevoice/releases/latest/download/kobevoice_x64.app.tar.gz)

    ```bash
    # Extract the archive
    tar -xzf kobevoice_x64.app.tar.gz
...
<Tabs items={["MSI Installer", "Setup Executable"]}>
  <Tab value="MSI Installer">
    Download: [kobevoice_x64_en-US.msi](https://github.com/kobepaytech/kobevoice/releases/latest/download/kobevoice_x64_en-US.msi)

    Double-click the MSI file and follow the installation wizard.
  </Tab>
  <Tab value="Setup Executable">
    Download: [kobevoice_x64-setup.exe](https://github.com/kobepaytech/kobevoice/releases/latest/download/kobevoice_x64-setup.exe)
...
When you launch Kobevoice for the first time:
...
2. **Data Directory** — Voice profiles and generated audio are stored in:
   - macOS: `~/Library/Application Support/com.kobepaytech.kobevoice/`
   - Windows: `%APPDATA%/com.kobepaytech.kobevoice/`
   - Linux: `~/.config/com.kobepaytech.kobevoice/`
