...
Kobevoice keeps a complete history of all generated audio, making it easy to find, reuse, and manage your creations.
...
- **macOS**: `~/Library/Application Support/com.kobepaytech.kobevoice/data/`
- **Windows**: `%APPDATA%/com.kobepaytech.kobevoice/data/`
- **Linux**: `~/.config/com.kobepaytech.kobevoice/data/`
