---
title: "Quick Start"
description: "Get started with Kobevoice in 5 minutes"
---
...
Make sure you have [installed Kobevoice](/overview/installation) and launched the app.

## Step 1: Create a Voice Profile

Voice profiles are the foundation of Kobevoice. Each profile contains voice samples that the AI uses to clone the voice.
...
<Steps>
  ...
  <Step title="Enter Text">
    ...
    ```
    Hello! This is my first voice generation with Kobevoice.
    ```
...
<Cards>
  ...
  <Card title="API Integration" href="/api-reference">
    Integrate Kobevoice into your own applications
  </Card>
