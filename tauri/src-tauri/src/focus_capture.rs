...
//! Kobevoice itself" and short-circuit the synthetic-paste path. On
//! Windows, `bundle_id` holds the lowercased exe basename (`"kobevoice.exe"`)
...
mod win {
    ...
    /// (e.g. `"kobevoice.exe"`). This is the Windows analogue of macOS'
