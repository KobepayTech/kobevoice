...
export const metadata: Metadata = {
	title: "Blog — Kobevoice",
	description: "Notes from building Kobevoice — the open-source AI voice studio.",
	openGraph: {
		title: "Kobevoice Blog",
		description: "Notes from building Kobevoice — the open-source AI voice studio.",
		type: "website",
		url: "https://kobevoice.app/blog",
