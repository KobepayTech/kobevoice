# Kobevoice Landing Page

Landing page for kobevoice.app - a modern Next.js 16 application.
...
5. Configure custom domain `kobevoice.app` in Railway settings
